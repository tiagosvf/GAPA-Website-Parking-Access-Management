...
namespace GAPA
{
    public class BaseDados
    {
        ...
        public DataTable pesquisarUtilizador(string text)
        {
            ...
            string sql = "SELECT Utilizadores.iId,Utilizadores.Nome,Utilizadores.Email,Utilizadores.Tipo,Utilizadores.Ativo,Utilizadores.Username,Perfis.Perfil FROM utilizadores INNER JOIN Perfis ON Utilizadores.perfil=Perfis.id WHERE Utilizadores.nome like @text or Utilizadores.id like @text or Utilizadores.email like @text or Utilizadores.username Like @text";
            List<SqlParameter> parametros = new List<SqlParameter>()
            {
